...
function BrandMark({ href = "/", className = "", light = false, compact = false }: BrandMarkProps) {
  const content = (
    <div className={`flex items-center gap-3 ${className}`}>
      <div className={`relative flex h-12 w-12 items-center justify-center overflow-hidden rounded-2xl border shadow-[0_14px_34px_rgba(15,23,42,0.14)] ${
        light
      ...
      {!compact && (
        <div className="leading-none">
          <p className={`font-display hidden text-sm font-bold tracking-[0.24em] uppercase md:block ${
